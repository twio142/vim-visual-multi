...
fun! vm#plugs#buffer() abort
  ...
  nnoremap <silent>        <Plug>(VM-Del)                     :<C-u>call b:VM_Selection.Edit.run_normal('x', {'count': v:count1, 'recursive': 0, 'store': b:VM_Selection.Vars.use_register})<cr>
  ...
  nnoremap <silent>        <Plug>(VM-Run)                     :<C-u>call b:VM_Selection.Edit.run(-1, {'count': v:count1})<cr>
  nnoremap <silent>        <Plug>(VM-Run-Last)                :<C-u>call b:VM_Selection.Edit.run_last()<cr>
